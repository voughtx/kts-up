...
TOKEN = os.environ.get("SHOW_ID2", "").strip() or os.environ.get("GH_TOKEN", "").strip()  # PAT SHOW_ID2 secret mein hai
TARGETS = ["voughtx/kts-up-2", "voughtx/kts-up-3", "voughtx/kts-up-4", "voughtx/kts-up-5"]
